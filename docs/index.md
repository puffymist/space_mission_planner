...
hero:
  ...
  text: Plan interplanetary missions in your browser
  tagline: A 2D orbital mechanics simulator with n-body gravity, Hohmann transfers, and delta-v maneuver planning.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: Launch App
      link: https://puffymist.github.io/space_mission_planner/

features:
  - title: N-Body Gravity Simulation
    details: Spacecraft trajectories are computed under gravitational influence from all 16 celestial bodies simultaneously, using an adaptive Velocity Verlet integrator.
